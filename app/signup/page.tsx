        ...
        {step === 'request' ? (
          <>
            ...
            <p style={{ textAlign: 'center', fontSize: 13, color: 'var(--ink-muted)', marginTop: 24 }}>
              By signing up, you agree to our <Link href="/terms" style={{ color: 'var(--ink)', textDecoration: 'underline' }}>Terms of Service</Link> and <Link href="/privacy" style={{ color: 'var(--ink)', textDecoration: 'underline' }}>Privacy Policy</Link>.
            </p>
          </>
        ) : (
